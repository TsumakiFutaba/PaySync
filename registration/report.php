	...
	<div class="container">
		<div class="register-box">
		  	<div class="register-logo">
		    	<a href="<?php echo BASE_URL; ?>reports/<?php echo $empDATA['emp_code']; ?>/"><b>PaySync</b></a>
		 ...
		 <div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="row">
					<label class="col-sm-3">Email Addres:</label>
					<div class="col-sm-9">
				...
				<hr />
				<div class="row">
					<label class="col-sm-3">Employee Type:</label>
					<div class="col-sm-9">
