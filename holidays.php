						...
						<form method="post" role="form" data-toggle="validator" id="holiday-form">
							<div class="modal-body">
								<div class="form-group">
                                    ...
                                    <small id="titleHelp" class="form-text text-danger" style="display: none;">Please enter only letters.</small>
                                </div>
								<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control datepicker pull-right" id="holiday_date" name="holiday_date" placeholder="MM/DD/YYYY" readonly required />
                                        <small id="dateHelp" class="form-text text-danger" style="display: none;">Please select a date from the calendar.</small>
                                    </div>
                                </div>
					            <div class="row">
					            	<div class="col-sm-6">
...
<script>
    document.getElementById('holiday_title').addEventListener('input', function () {
        var inputValue = this.value;
        var validInput = /^[A-Za-z]+$/.test(inputValue);
        var errorField = document.getElementById('titleHelp');
        if (!validInput) {
            errorField.style.display = 'block';
            this.setCustomValidity('Please enter only letters.');
        } else {
